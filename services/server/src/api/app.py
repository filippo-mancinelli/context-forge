...
async def list_tools():
    ...
    try:
        ...
        tools = [
            ...
            {"name": "repo_references", "description": "Find all references to a symbol (function, class, variable) across indexed repos."},
            {"name": "code_explain", "description": "Explain what a piece of code does using the configured LLM."},
            {"name": "repo_annotate", "description": "Add a persistent annotation/note on a file or code chunk."},
            {"name": "repo_annotations", "description": "List annotations for a repository, optionally filtered by file."},
